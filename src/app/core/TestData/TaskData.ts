...
export class TaskData {
  static getTasks(): Task[] {
    return [
      { id: 1, projectId: 1, title: 'Analyse', description: 'Erste Anforderungsanalyse', assignedTo: 'Alice Schmidt', dueDate: new Date('2024-02-15'), status: TaskStatus.InProgress },
